ossia uses the [Berlin code of conduct](https://berlincodeofconduct.org/) as basis for every conference, public event, and online interaction.
Our contact address useable for any matter including those covered by the code of conduct is [contact@ossia.io](mailto:contact@ossia.io).
